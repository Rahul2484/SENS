...
<p class="fake-legend"><span>SUGGESTION TABLE</span>
</p>
...
if ($result->num_rows > 0) {
	...
	echo "<tr><th>ID</th><th>Suggestions</th></tr><!-- Table Header -->";
    while($row = $result->fetch_assoc()) {
		
		echo "<tr><td><input type=checkbox name=check_list[] value=$row[id]> $row[id] <td>$row[suggestion]</td></tr><!-- Table Row -->";
